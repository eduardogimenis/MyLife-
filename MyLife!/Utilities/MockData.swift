...
struct MockData {
    static func generateSampleEvents() -> [LifeEvent] {
        ...
        return [
            ...
            LifeEvent(title: "Elementary School", date: calendar.date(byAdding: .year, value: -25, to: now)!, endDate: calendar.date(byAdding: .year, value: -20, to: now)!, isApproximate: true, category: .education),
            ...
            LifeEvent(title: "First Internship", date: calendar.date(byAdding: .year, value: -10, to: now)!, endDate: calendar.date(byAdding: .month, value: 3, to: calendar.date(byAdding: .year, value: -10, to: now)!)!, isApproximate: false, category: .work, locationName: "Tech Corp"),
            LifeEvent(title: "Graduated College", date: calendar.date(byAdding: .year, value: -8, to: now)!, isApproximate: false, category: .education),
            LifeEvent(title: "Backpacking across Europe", date: calendar.date(byAdding: .year, value: -7, to: now)!, endDate: calendar.date(byAdding: .month, value: 2, to: calendar.date(byAdding: .year, value: -7, to: now)!)!, isApproximate: true, category: .travel, notes: "Best summer ever!"),
            LifeEvent(title: "First Full-time Job", date: calendar.date(byAdding: .year, value: -6, to: now)!, endDate: calendar.date(byAdding: .year, value: -4, to: now)!, isApproximate: false, category: .work, locationName: "Startup Inc"),
